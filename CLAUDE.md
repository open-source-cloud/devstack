...
<!-- >>> devstack >>> (managed — do not edit; regenerate with `devstack ai install`) -->
@AGENTS.md

The devstack section of AGENTS.md above is generated by `devstack ai install`.
Run `devstack ai docs` to read devstack's full documentation from the binary.
<!-- <<< devstack <<< -->
