...
| 22 | Interactive DX: active context, shell integration & authoring | ~6w | shipped (M10 DX) · [spec 30](specs/30-interactive-dx-and-shell.md) · [D18](DECISIONS.md) |
| 23 | JS/monorepo templates + task-graph runner (`devstack run`) | ~8w | shipped (M10 DX) · [spec 31](specs/31-js-monorepo-templates-and-run.md) · [D19](DECISIONS.md) |
